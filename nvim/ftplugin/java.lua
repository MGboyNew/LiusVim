local config = {
  cmd = {
    ...
    "-javaagent:/home/lius/.local/share/nvim/lsp/jdt-language-server/lombok.jar",
    "-Xbootclasspath/a:/home/lius/.local/share/nvim/lsp/jdt-language-server/lombok.jar",
    "-jar",
    "/home/lius/.local/share/nvim/lsp/jdt-language-server/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar",
    "-configuration",
    "/home/lius/.local/share/nvim/lsp/jdt-language-server/config_linux",
    "-data",
    "/home/lius/.local/share/nvim/lsp/jdt-language-server/workspace/folder"
  },
...
-- java_on_attach(nil, current_buff) -- 我给替换成下面的了，我看见官网上说第一个参数是number，所以我给了0
java_on_attach(nil, 0)


--  来源 https://blog.csdn.net/lxyoucan/article/details/123453802,我改了代码 因为很多地方报错了 vim.api.nvim_buf_set_keymap 第一个参数的原因
